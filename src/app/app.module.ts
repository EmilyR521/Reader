...
import { CsvImportExportComponent } from './components/views/settings/csv-import-export/csv-import-export.component';
...
import { CollectionsViewComponent } from './components/views/collections/collections-view.component';
import { SettingsViewComponent } from './components/views/settings/settings-view.component';
